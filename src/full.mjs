...
import prov_color from 'casual/src/providers/color.js'
import prov_date from 'casual/src/providers/date.js'
import prov_internet from 'casual/src/providers/internet.js'
import prov_misc from 'casual/src/providers/misc.js'
...
casual.register_provider( helpers.extend( prov_color ))
casual.register_provider( helpers.extend( prov_date ))
casual.register_provider( helpers.extend( prov_internet ))
casual.register_provider( helpers.extend( prov_misc ))
